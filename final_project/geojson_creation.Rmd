...
tract_1920 <- tract_1920 %>% 
  ...
  #column_to_rownames("id") ##### if I set the new id column to be the row names, then the geosjon breaks

#tract_1920 <- rowid_to_column(tract_1920, "id")

plot(tract_1920 %>% select(black_per))
st_write(tract_1920, "data/working_data/race_1920_tract_albers.geojson")
```
...
st_write(tract_1930, "data/working_data/race_1930_tract_albers.geojson")
```
