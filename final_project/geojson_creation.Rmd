...
tract_1920 <- tract_1920 %>% 
  mutate(id = as.numeric(substring(GISJOIN, 2)))

#tract_1920 <- rowid_to_column(tract_1920, "id")
st_crs(tract_1920)
plot(tract_1920 %>% select(black_per))
st_write(tract_1920, "data/working_data/race_1920_tract.geojson")
```
...
st_write(tract_1930, "data/working_data/race_1930_tract.geojson")
```
...
st_write(tract_1940, "data/working_data/race_1940_tract.geojson")
```
...
st_write(tract_1950, "data/working_data/race_1950_tract.geojson")
```
...
st_write(tract_1960, "data/working_data/race_1960_tract.geojson")
```
...
st_write(tract_1970, "data/working_data/race_1970_tract.geojson")
```
...
st_write(tract_1980, "data/working_data/race_1980_tract.geojson")
```
