...
//how chart is being updated. We are building are bins dynamically
    function updateChart(m) {
        ...
        .join(
            ...
            g.append("text")
                ...
                .attr("fill", "#333")
                .transition()
                .duration(750)  //length of transition
                .attr("y", d => y(d.length) - 5);
            },
            update => { //how its being updated
            update.select("rect")
                .transition()
                .duration(750)
                .attr("y", d => y(d.length))
        ...
        let temp = d3.mean(data[m], d => d.average).toFixed(1); //to fixed rounds the number
        ...
        svg.append("foreignObject")
          ...
          .attr("width", 120)
          .attr("height", 100)
          .append('xhtml:div')//so Safari loads the foreign object
          .append("p")
          .html(str);
    }
